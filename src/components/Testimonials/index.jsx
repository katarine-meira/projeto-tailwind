...
import TestimonialsAvatar from "../../assets/images/testimonials/avatar-1.png"
        ...
        <section className="bg-white">
            <div className="w-full max-w-[360px] md:max-w-[900px] mx-auto flex flex-col items-center justify-center gap-[80px] md:px-2 xl:px-0">
                ...
                <div className="flex flex-col py-4 items-center justify-center gap-11 md:gap-12">
                    <img src={IbmLogo} alt="" />
                    <p className="text-center text-sm text-secondary-text font-bold w-full max-w-[280px] md:max-w-none md:text-2xl md:font-normal">Most calendars are designed for teams. Slate is designed for freelancers
                        who want a simple way to plan their schedule.</p>
                    <div className="flex gap-3 justify-center items-center">
                        <img src={TestimonialsAvatar} alt="" />
                        <div>
